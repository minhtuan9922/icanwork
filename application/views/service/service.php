	...
	<div class="container">
		<div class="row">
			<section class="page col-sm-9">
				<h2 class="page-title">NỘI DỤNG DỊCH VỤ</h2>
				<div class="entry">
			...
			<aside class="sidebar col-sm-3">
				<div class="widget">
					<h4>DỊCH VỤ</h4>
					<ul>
						<li class="current"><a data-toggle="pill" href="#home" title="">Dịch vụ đăng tin</a></li>
						<li><a data-toggle="pill" href="#menu1" title="">Dịch vụ quảng cáo</a></li>
						<li><a data-toggle="pill" href="#menu2" title="">Nâng cấp tài khoản</a></li>
						<li><a data-toggle="pill" href="#menu3" title="">Tư vấn khách hàng</a></li>
					</ul>
				</div>
